    ...
    <section id="projects" className="py-24">
      <div className="container-content">
        ...
        <div className="space-y-8">
          {/* Featured project — full width, highlighted */}
          {featured && (
            <div className="relative border border-accent/40 bg-accent/[0.03] rounded-xl p-6 sm:p-8 hover:border-accent/60 transition-colors">
              {/* Featured badge */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {others.map((project) => (
              <div
                key={project.name}
                className="border border-border bg-bg-elevated rounded-xl p-6 hover:border-border-light transition-colors flex flex-col"
              >
